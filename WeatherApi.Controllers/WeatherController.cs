...
namespace WeatherApi.Controllers
{
    ...
    public class WeatherController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetWeather(double latitude = 34.05, double longitude = -118.25, string? date = null)
        {
            ...
            try
            {
                ...
                // If no valid weather data for the date, return 404
                ...
                {
                    return Ok(new { weatherDto, nasaRaw });
                }
